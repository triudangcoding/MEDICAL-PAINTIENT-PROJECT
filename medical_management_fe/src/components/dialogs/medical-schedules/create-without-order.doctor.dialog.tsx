...
interface CreateMedicalScheduleWithoutOrderDoctorDialogProps {
  open: boolean;
...
export function CreateMedicalScheduleWithoutOrderDoctorDialog({
  open,
  onOpenChange,
  doctorId,
  onCreateSuccess,
}: CreateMedicalScheduleWithoutOrderDoctorDialogProps) {
